...
#import "emu48.h" // Added by mksg.de

#import "opcodes.h"
#import "apple.h"   // Added by Marek Zima (The Winter Storm.COM)
...
VOID o807(LPBYTE I) // SHUTDN
{
	...
	if (w.in == 0 && bShutdn)				// shut down only when enabled
	{
		...
		if (   (cCurrentRomType=='E' || cCurrentRomType=='G' || cCurrentRomType=='X'  || cCurrentRomType=='Q')
...
VOID o80B(LPBYTE I) // BUSCC
{
    ...
    //MZI Implementation for HP50G - verry important !!!!
