...
//MZI #include "pch.h" - Marcus changed the file with pathwinpch.h
#include "patchwinpch.h"
#include "Emu48.h"
#include "Opcodes.h"
#include "apple.h"
...
// #define _KB(s)	((s) * 1024 * 2)        //MZI - Already defined
...
//	dwAddress = RPL_CreateTemp(dwC,FALSE);	// allocate memory
	dwAddress = RPL_CreateTemp(dwC);	// allocate memory
	if (dwAddress)
	{
...
VOID o80BExt(LPBYTE I) // Saturnator extentions
{
	...
	switch (I[3]+(I[4]<<4))
	{
        ...
        case 0x28: 
            ...
            break; // HST=1.x
        case 0x29:
            w.A[4]= w.A[3]= w.A[2]= w.A[0]= 0; 
            if (cCurrentRomType=='Q') w.A[1]=5; 
            else w.A[1]=4; 
            break; // screen height = 0x50 = 80
...
//        case 0x31: w.d0address=0; Map(0,0xff); RefreshDisp0(); break; //unconfig_disp0 does the refresh
        case 0x31: w.d0address=0; Map(0,0xff); UpdateDisplay(); break; //unconfig_disp0 does the refresh
//        case 0x32: RefreshDisp0(); break; //refresh_disp0 force refresh
        case 0x32: UpdateDisplay(); break; //refresh_disp0 force refresh
//        case 0x33: a= Npack(w.C,2); if (a>(DWORD)SCREENHEIGHT) a= SCREENHEIGHT; /* w.lcounter = (SCREENHEIGHT-a) */; w.d0size= a; RefreshDisp0(); break; //set_lines_disp0 nb in Cb
        //case 0x33: a= Npack(w.C,2); if (a>(DWORD)SCREENHEIGHT) a= SCREENHEIGHT; w.d0size= a; UpdateDisplay(); break; //set_lines_disp0 nb in Cb
        case 0x33: a= Npack(w.C,2); if (a>(DWORD)SCREENHEIGHT) a= SCREENHEIGHT; w.d0size= a; break; //set_lines_disp0 nb in Cb
