...
#define AVMEM       (((cCurrentRomType!='X' && cCurrentRomType!='Q'))?((cCurrentRomType=='S')?0x7066E:0x807ED):0x80E9B)
#define INTRPPTR    (((cCurrentRomType!='X' && cCurrentRomType!='Q'))?((cCurrentRomType=='S')?0x705B0:0x8072F):0x8076B)
#define SYSTEMFLAGS (((cCurrentRomType!='X' && cCurrentRomType!='Q'))?((cCurrentRomType=='S')?0x706C5:0x80843):0x80F02)
...
static DWORD RPL_GarbageCol(VOID)			// RPL variables must be in system RAM
{
	...
	_ASSERT(cCurrentRomType == 'S' || cCurrentRomType == 'G' || cCurrentRomType == 'X' || cCurrentRomType == 'Q');
...
DWORD RPL_SkipOb(DWORD d)
{
	...
	switch (n)
	{
	case DOFLASHP: l = (cCurrentRomType!='X'  && cCurrentRomType!='Q') ? 5 : 12; break; // Flash PTR (HP49G)
