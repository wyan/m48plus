...
// m48 extension:
#define LBTNDOWN	0x0100					// Any button is currently pressed
#define LALPHALOCK	0x0200					// additional state of synchronous state-machine for keyboard state
#define LALPHASMALL	0x0400					// additional state of synchronous state-machine for keyboard state
#define LDON		0x0800					// additinal state for display on
#define LACKNOK		0x4000					// additional bit to give feeedback to the skin on copy/paste operation
#define LACKNERR	0x8000					// additional state to give feeedback to the skin on copy/paste operation
