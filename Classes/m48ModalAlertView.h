...
extern const NSString *tModalAlertViewWait;
extern const NSString *tModalAlertViewSuccess;
extern const NSString *tModalAlertViewError;

@interface m48ModalAlertView : UIAlertView <UIAlertViewDelegate> {
