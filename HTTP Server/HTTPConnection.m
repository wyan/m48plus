...
- (void)replyToHTTPRequest
{
	...
	//original: if(!version || ![version isEqualToString:(NSString *)kCFHTTPVersion1_1])
	//seems to work too: if(!version || !([version isEqualToString:(NSString *)kCFHTTPVersion1_1] || [version isEqualToString:(NSString *)kCFHTTPVersion1_0]))	
...
- (void)handleVersionNotSupported:(NSString *)version
{
	...
	////DEBUG NSLog(@"HTTP Server: Error 505 - Version Not Supported: %@", version);
...
- (void)handleAuthenticationFailed
{
	...
	////DEBUG NSLog(@"HTTP Server: Error 401 - Unauthorized");
...
- (void)handleInvalidRequest:(NSData *)data
{
	...
	////DEBUG NSLog(@"HTTP Server: Error 400 - Bad Request");
...
- (void)handleUnknownMethod:(NSString *)method
{
	...
	////DEBUG NSLog(@"HTTP Server: Error 405 - Method Not Allowed: %@", method);
...
- (void)handleResourceNotFound
{
	...
	////DEBUG NSLog(@"HTTP Server: Error 404 - Not Found");
...
- (BOOL)onSocketWillConnect:(AsyncSocket *)sock
{
	if([self isSecureServer])
	{
		...
		{
			////DEBUG NSLog(@"Securing connection...");
...
{
//	//DEBUG NSLog(@"HTTPConnection: onSocket:willDisconnectWithError: %@", err);
}
